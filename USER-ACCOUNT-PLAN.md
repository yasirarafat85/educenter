...
> স্ট্যাটাস: **ধাপ ১ সম্পন্ন ও isolated-টেস্টেড (২০২৬-০৮-১২)** — লাইভে নিতে `migrate-user-accounts.sql` চালাতে হবে। ধাপ ২ (Google) বাকি। ইউজারের সাথে ২০২৬-০৮-১২ এ ঠিক করা।
