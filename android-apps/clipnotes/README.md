...
- **Settings** — লাইট/ডার্ক/সিস্টেম থিম (ডার্ক থিম Pro-ফিচার, ডেমো হিসেবে)
- Share (অন্য অ্যাপে পাঠানো)
- **Export / Import** — সব নোট ফাইলে সেভ ও ফেরানো (ফোন-নিরপেক্ষ ব্যাকআপ)
- **Google Auto Backup** — allowBackup চালু, ইউজারের Google অ্যাকাউন্টে অটো ব্যাকআপ/রিস্টোর
- **Activation Key (Pro)** — ডিভাইস-লক key দিয়ে Pro ফিচার আনলক (`data/License.kt`); key জেনারেটর আলাদা প্রাইভেট HTML টুলে (রিপোতে রাখা হয় না)
