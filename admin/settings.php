...
$groups = [
    ...
    'কোর্সের ছবি ও ভিডিও বোতাম (কোর্সের পেজে)' => [
        ...
        'course_media_video_label' => ['label' => 'ভিডিওর বোতামে যা লেখা থাকবে', 'type' => 'text', 'help' => 'খালি রাখলে দেখাবে: ▶️ কোর্স ভিডিও। ছবি/ভিডিও যোগ করা হয় কোর্স → ব্যাচ তালিকা → "🖼️ ছবি/ভিডিও" থেকে; ওয়ার্কশিট/প্রোডাক্টে ঐ তালিকার একই নামের লিংক থেকে (বোতামের এই লেখা তিন জায়গাতেই এক)।'],
