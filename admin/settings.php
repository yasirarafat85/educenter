...
$groups = [
    ...
    'কোর্সের ছবি ও ভিডিও বোতাম (কোর্সের পেজে)' => [
        ...
        'course_media_card_label'  => ['label' => 'কোর্স কার্ডের বোতামে যা লেখা থাকবে', 'type' => 'text', 'help' => 'হোমপেজ/কোর্স তালিকার কার্ডে "বিস্তারিত দেখুন"-এর পাশের বোতাম। খালি রাখলে দেখাবে: প্রিভিউ দেখুন।'],
    ],
