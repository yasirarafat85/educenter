...
$guide = [
    'শুরুতেই যা জানা দরকার' => ['rocket', 'bg-indigo-100 text-indigo-600', [
        ...
        ['🚚 কোর্সের পার্সেল পাঠাতে', 'আগে "পার্সেল প্রস্তুত" → কোর্স/ব্যাচ/মাস বেছে পার্সেল বানান, তারপর "কুরিয়ার" পেজ থেকে পাঠান।', 'courier-prepare.php'],
    ...
    'কুরিয়ার' => ['truck', 'bg-purple-100 text-purple-600', [
        ['পার্সেল প্রস্তুত', 'কোর্স/ব্যাচ/মাস বেছে প্রতি শিক্ষার্থীর কালেকশন (অটো হিসাব) সহ পার্সেল তৈরি করুন।', 'courier-prepare.php'],
        ['কুরিয়ার', 'প্রস্তুত পার্সেল দেখুন ও কুরিয়ারে পাঠান (Pathao/Steadfast)। ফিল্টার আছে।', 'courier.php'],
        ['কুরিয়ার ট্র্যাকিং', 'কোন শিক্ষার্থীর কোন মাসের পার্সেল গেছে/যায়নি — ছক আকারে।', 'courier-tracking.php'],
    ]],
