...
<script>
    ...
    (function () {
        ...
        if (document.querySelector('#regFilterForm, #courierFilterForm, #logsFilterForm, #ciFilterForm, #usersFilterForm, #lsFilterForm, #ureqFilterForm, #llFilterForm, #alFilterForm')) { return; }
